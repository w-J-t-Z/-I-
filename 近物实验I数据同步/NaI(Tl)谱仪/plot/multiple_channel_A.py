...
ax1.plot([143.2,143.2],[1360,1560],color="black",lw=3)
ax1.text(153.2,1460,"143.2",fontsize=20)

ax1.plot([752.3,752.3],[538,738],color="black",lw=3)
ax1.text(762.3,638,"752.3",fontsize=20)
