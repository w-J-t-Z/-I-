...
ax1.plot([128.8,128.8],[598,798],color="black",lw=3)
ax1.text(138.8,698,"128.8",fontsize=20)

ax1.plot([434.4,434.4],[705,905],color="black",lw=3)
ax1.text(444.4,805,"434.4",fontsize=20)
