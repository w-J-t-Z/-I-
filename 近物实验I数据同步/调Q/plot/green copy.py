...
para,pcov=curve_fit(Fun,cc12,powerAV)
...
ax1.text(140,10,"$P_g$(mW)=%.2f$P_{LD}(mW)^2$"%(para[0]),fontsize=20)
...
ax2.set_ylim(ymin = 0, ymax = 0.03)

y2_major_locator=MultipleLocator(0.005)
y2_minor_locator=MultipleLocator(0.001)
#调用刻度设置
